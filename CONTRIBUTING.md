# Contributing to Stack Exchange Sticky Header
...
There are a number of ways to get involved with the development of this Stack Exchange Sticky Header theme. Even if you've never contributed to an Open Source project before, we're always looking for help identifying missing styles or other issues.
...
* [Download](https://github.com/StylishThemes/StackExchange-Sticky-Header/archive/master.zip), [fork](https://github.com/StylishThemes/StackExchange-Sticky-Header/fork) or clone this repository.
* Use [node.js](http://nodejs.org/) to run `npm install`.
* Make any changes to the `StackExchange-Sticky-Header.user.css` file and save.

### Build & test

* Create & change into a new branch of your local Stack Exchange Sticky Header repository.
...
* Now you can add and commit the changes of the `stack-exchange-sticky-header.user.css` file to your fork's branch.
